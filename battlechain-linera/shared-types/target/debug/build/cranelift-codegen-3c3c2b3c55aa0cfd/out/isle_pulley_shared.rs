...
/// Internal type MInst: defined at src/isa/pulley_shared/inst.isle line 4.
#[derive(Clone, Debug)]
pub enum MInst {
    Args {
        args: VecArgPair,
...
/// Internal type Amode: defined at src/isa/pulley_shared/inst.isle line 109.
#[derive(Clone, Debug)]
pub enum Amode {
    SpOffset { offset: i64 },
...
/// Internal type ExtKind: defined at src/isa/pulley_shared/inst.isle line 117.
...
pub fn constructor_put_in_xreg<C: Context>(ctx: &mut C, arg0: Value) -> XReg {
    ...
    // Rule at src/isa/pulley_shared/inst.isle line 148.
    return v2;
}
...
pub fn constructor_output_xreg<C: Context>(ctx: &mut C, arg0: XReg) -> InstOutput {
    ...
    // Rule at src/isa/pulley_shared/inst.isle line 153.
    return v2;
}
...
pub fn constructor_writable_xreg_to_reg<C: Context>(ctx: &mut C, arg0: WritableXReg) -> Reg {
    ...
    let v2 = C::writable_reg_to_reg(ctx, v1);
    // Rule at src/isa/pulley_shared/inst.isle line 168.
    return v2;
}
...
pub fn constructor_xreg_to_value_regs<C: Context>(ctx: &mut C, arg0: XReg) -> ValueRegs {
    let v1 = C::xreg_to_reg(ctx, arg0);
    let v2 = C::value_reg(ctx, v1);
    // Rule at src/isa/pulley_shared/inst.isle line 178.
    return v2;
}
...
pub fn constructor_temp_writable_xreg<C: Context>(ctx: &mut C) -> WritableXReg {
    ...
    // Rule at src/isa/pulley_shared/inst.isle line 188.
    return v2;
}
...
pub fn constructor_put_in_freg<C: Context>(ctx: &mut C, arg0: Value) -> FReg {
    ...
    // Rule at src/isa/pulley_shared/inst.isle line 208.
    return v2;
}
...
pub fn constructor_output_freg<C: Context>(ctx: &mut C, arg0: FReg) -> InstOutput {
    ...
    let v2 = constructor_output_reg(ctx, v1);
    // Rule at src/isa/pulley_shared/inst.isle line 213.
    return v2;
}
...
pub fn constructor_freg_to_value_regs<C: Context>(ctx: &mut C, arg0: FReg) -> ValueRegs {
    let v1 = C::freg_to_reg(ctx, arg0);
    let v2 = C::value_reg(ctx, v1);
    // Rule at src/isa/pulley_shared/inst.isle line 238.
    return v2;
}
...
pub fn constructor_writable_freg_to_value_regs<C: Context>(
    ...
    let v2 = C::value_reg(ctx, v1);
    // Rule at src/isa/pulley_shared/inst.isle line 243.
    return v2;
}
...
pub fn constructor_temp_writable_freg<C: Context>(ctx: &mut C) -> WritableFReg {
    ...
    // Rule at src/isa/pulley_shared/inst.isle line 248.
    return v2;
}
...
pub fn constructor_put_in_vreg<C: Context>(ctx: &mut C, arg0: Value) -> VReg {
    ...
    // Rule at src/isa/pulley_shared/inst.isle line 268.
    return v2;
}
...
pub fn constructor_output_vreg<C: Context>(ctx: &mut C, arg0: VReg) -> InstOutput {
    ...
    let v2 = constructor_output_reg(ctx, v1);
    // Rule at src/isa/pulley_shared/inst.isle line 273.
    return v2;
}
...
pub fn constructor_writable_vreg_to_reg<C: Context>(ctx: &mut C, arg0: WritableVReg) -> Reg {
    ...
    let v2 = C::writable_reg_to_reg(ctx, v1);
    // Rule at src/isa/pulley_shared/inst.isle line 288.
    return v2;
}
...
pub fn constructor_writable_vreg_to_value_regs<C: Context>(
    ...
    let v2 = C::value_reg(ctx, v1);
    // Rule at src/isa/pulley_shared/inst.isle line 303.
    return v2;
}
...
pub fn constructor_imm<C: Context>(ctx: &mut C, arg0: Type, arg1: u64) -> Reg {
    ...
    match arg0 {
        ...
        I32 => {
            ...
            // Rule at src/isa/pulley_shared/inst.isle line 333.
            return v26;
        }
        I64 => {
        ...
        F64 => {
            ...
            // Rule at src/isa/pulley_shared/inst.isle line 338.
            return v37;
        }
        _ => {}
    }
    unreachable!(
        "no rule matched for term {} at {}; should it be partial?",
        "imm", "src/isa/pulley_shared/inst.isle line 313"
    )
}
...
pub fn constructor_gen_bitcast<C: Context>(ctx: &mut C, arg0: Reg, arg1: Type, arg2: Type) -> Reg {
    ...
    if arg1 == arg2 {
        // Rule at src/isa/pulley_shared/inst.isle line 348.
        return arg0;
    }
    unreachable!(
        "no rule matched for term {} at {}; should it be partial?",
        "gen_bitcast", "src/isa/pulley_shared/inst.isle line 343"
    )
}
...
pub fn constructor_pulley_xconst64<C: Context>(ctx: &mut C, arg0: i64) -> XReg {
    ...
    let v3 = C::emit(ctx, &v2);
    let v4 = C::writable_xreg_to_xreg(ctx, v1);
    // Rule at src/isa/pulley_shared/inst.isle line 381.
    return v4;
}
...
pub fn constructor_pulley_br_if_xslteq32<C: Context>(
    ...
    let v5 = SideEffectNoResult::Inst { inst: v4 };
    // Rule at src/isa/pulley_shared/inst.isle line 407.
    return v5;
}
...
pub fn constructor_pulley_xult64<C: Context>(ctx: &mut C, arg0: XReg, arg1: XReg) -> XReg {
    ...
    let v4 = C::emit(ctx, &v3);
    let v5 = C::writable_xreg_to_xreg(ctx, v2);
    // Rule at src/isa/pulley_shared/inst.isle line 455.
    return v5;
}
...
pub fn constructor_pulley_bitcast_float_from_int_64<C: Context>(ctx: &mut C, arg0: XReg) -> FReg {
    ...
    let v3 = C::emit(ctx, &v2);
    let v4 = C::writable_freg_to_freg(ctx, v1);
    // Rule at src/isa/pulley_shared/inst.isle line 519.
    return v4;
}
    ...
    match v1 {
        &InstructionData::Binary {
            ...
            if let &Opcode::Iadd = v49 {
                let v40 = C::first_result(ctx, arg0);
                if let Some(v41) = v40 {
                    let v42 = C::value_type(ctx, v41);
                    match v42 {
                        I8 => {
                            let v51 = C::unpack_value_array_2(ctx, v50);
                            let v54 = constructor_put_in_xreg(ctx, v51.0);
                            let v55 = constructor_put_in_xreg(ctx, v51.1);
                            let v56 = constructor_pulley_xadd32(ctx, v54, v55);
                        ...
                        I64 => {
                            ...
                            let v54 = constructor_put_in_xreg(ctx, v51.0);
                            let v55 = constructor_put_in_xreg(ctx, v51.1);
                            let v59 = constructor_pulley_xadd64(ctx, v54, v55);
        ...
        &InstructionData::Call {
            ...
            match v16 {
                &Opcode::Call => {
                    let v20 = C::func_ref_data(ctx, v18);
                    let v19 = C::value_list_slice(ctx, v17);
                    let v24 = C::gen_call(ctx, v20.0, v20.1, v20.2, v19);
                    let v25 = Some(v24);
                ...
                &Opcode::ReturnCall => {
                    let v20 = C::func_ref_data(ctx, v18);
                    let v19 = C::value_list_slice(ctx, v17);
                    let v36 = C::gen_return_call(ctx, v20.0, v20.1, v20.2, v19);
                    let v37 = Some(v36);
        ...
        &InstructionData::CallIndirect {
            ...
            match v26 {
                &Opcode::CallIndirect => {
                    let v29 = C::value_list_slice(ctx, v27);
                    let v30 = C::value_slice_unwrap(ctx, v29);
                    if let Some(v31) = v30 {
                        let v34 = C::gen_call_indirect(ctx, v28, v31.0, v31.1);
                        let v35 = Some(v34);
                ...
                &Opcode::ReturnCallIndirect => {
                    ...
                    let v30 = C::value_slice_unwrap(ctx, v29);
                    if let Some(v31) = v30 {
                        let v38 = C::gen_return_call_indirect(ctx, v28, v31.0, v31.1);
                        let v39 = Some(v38);
        ...
        &InstructionData::IntCompare {
            ...
            if let &Opcode::Icmp = v62 {
                let v65 = C::unpack_value_array_2(ctx, v63);
                let v68 = C::value_type(ctx, v65.1);
                if v68 == I64 {
                    let v70 = constructor_lower_icmp(ctx, I64, v64, v65.0, v65.1);
                    let v71 = constructor_output_xreg(ctx, v70);
                    let v72 = Some(v71);
                    // Rule at src/isa/pulley_shared/lower.isle line 109.
                    return v72;
                }
                let v73 = C::fits_in_32(ctx, v68);
                if let Some(v74) = v73 {
                    let v76 = constructor_lower_icmp(ctx, I32, v64, v65.0, v65.1);
                    let v77 = constructor_output_xreg(ctx, v76);
                    let v78 = Some(v77);
                    // Rule at src/isa/pulley_shared/lower.isle line 111.
                    return v78;
                }
            }
        }
        &InstructionData::Load {
            ...
            if let &Opcode::Load = v79 {
                let v40 = C::first_result(ctx, arg0);
                if let Some(v41) = v40 {
                    let v84 = constructor_put_in_xreg(ctx, v80);
                    let v83 = C::offset32(ctx, v82);
                    let v85 = C::i32_as_i64(ctx, v83);
                    let v86 = Amode::RegOffset {
                        base: v84,
                        offset: v85,
                    };
                    let v42 = C::value_type(ctx, v41);
                    let v88 = constructor_pulley_load(ctx, &v86, v42, v81, &ExtKind::Zero);
        ...
        &InstructionData::MultiAry {
            ...
            if let &Opcode::Return = v11 {
                let v13 = C::value_list_slice(ctx, v12);
                let v14 = constructor_lower_return(ctx, v13);
                let v15 = Some(v14);
                // Rule at src/isa/pulley_shared/lower.isle line 69.
                return v15;
            }
        }
        &InstructionData::NullAry { opcode: ref v7 } => {
            if let &Opcode::GetStackPointer = v7 {
                let v8 = constructor_pulley_get_sp(ctx);
                let v9 = constructor_output_xreg(ctx, v8);
                let v10 = Some(v9);
        ...
        &InstructionData::Store {
            ...
            if let &Opcode::Store = v91 {
                let v95 = C::unpack_value_array_2(ctx, v92);
                let v100 = constructor_put_in_xreg(ctx, v95.1);
                let v103 = C::put_in_reg(ctx, v95.0);
                let v99 = C::offset32(ctx, v94);
                let v101 = C::i32_as_i64(ctx, v99);
                let v102 = Amode::RegOffset {
                    base: v100,
                    offset: v101,
                };
                let v98 = C::value_type(ctx, v95.0);
                let v104 = &constructor_pulley_store(ctx, &v102, v103, v98, v93);
        ...
        &InstructionData::UnaryImm {
            ...
            if let &Opcode::Iconst = v43 {
                ...
                if let Some(v41) = v40 {
                    ...
                    let v46 = constructor_imm(ctx, v42, v45);
...
pub fn constructor_lower_icmp<C: Context>(
    ...
    match arg1 {
        &IntCC::Equal => {
            match arg0 {
                I32 => {
                    ...
                    // Rule at src/isa/pulley_shared/lower.isle line 134.
                    return v12;
                }
                I64 => {
                    let v4 = constructor_put_in_xreg(ctx, arg2);
                    ...
                    // Rule at src/isa/pulley_shared/lower.isle line 116.
                    return v6;
                }
                _ => {}
            }
        ...
        &IntCC::NotEqual => {
            match arg0 {
                ...
                I64 => {
                    ...
                    // Rule at src/isa/pulley_shared/lower.isle line 119.
                    return v7;
                }
                _ => {}
            }
        ...
        &IntCC::SignedGreaterThan => {
            ...
            // Rule at src/isa/pulley_shared/lower.isle line 154.
            return v19;
        }
        &IntCC::SignedGreaterThanOrEqual => {
        ...
        &IntCC::SignedLessThan => {
            match arg0 {
                ...
                I64 => {
                    ...
                    // Rule at src/isa/pulley_shared/lower.isle line 122.
                    return v8;
                }
                _ => {}
            }
    ...
    unreachable!(
        "no rule matched for term {} at {}; should it be partial?",
        "lower_icmp", "src/isa/pulley_shared/lower.isle line 114"
    )
}
